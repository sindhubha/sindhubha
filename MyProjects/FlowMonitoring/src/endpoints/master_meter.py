...
if os.path.exists(file_path):
    ...
    if content == 'MySQL':
        ...
        from src.models.mysql.master_meter_model import meter_Lists,getmeterdtl,save_meter,update_meter,update_meterStatus,meter_historylist,check_import_meter,save_excel_meter,checkdemanddtl,checkconverterlimt,checkslaveid,save_transformer_meter,transformer_meter_list
    elif content == 'MSSQL':
...
async def save_meter_details(company_id: int = Form(''),
    ...
    try:
        ...
        if meter_id == "":
            ...
            await save_meter(cnx, company_id,bu_id,plant_id,plant_department_id,campus_id,function_id,converter_id,meter_id,meter_code,meter_name,ip_address,port,major_nonmajor,model_name,IMEI,user_login_id,function2_id,address,parameter, sub_parameter,meter_type,source,physical_location,max_demand,max_pf,main_demand_meter,consumption_type,is_poll_meter,meter,equipment_group_id,equipment_id,mac,obj)
            ...
            await update_meter(cnx, company_id,bu_id,plant_id,plant_department_id,campus_id,function_id,converter_id,meter_id,meter_code,meter_name,ip_address,port,major_nonmajor,model_name,IMEI,user_login_id,function2_id,address,parameter, sub_parameter,meter_type,source,physical_location,max_demand,max_pf,main_demand_meter,consumption_type,is_poll_meter,meter,equipment_group_id,equipment_id,mac,obj)
